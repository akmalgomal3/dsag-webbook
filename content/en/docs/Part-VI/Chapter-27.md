...
|-----------|---------|------|-------|----------|
| Factorial | func recursion | ... | ... stack | Basic example |
| Fibonacci memo | map[int]int | ... | ... | Classic DP |
| Merge Sort | []int | ... | ... | Stable sorting |
| Quick Sort | []int | ... avg | ... | In-place sorting |
| Knapsack 0/1 | [][]int | ... | ... | Combinatorial DP |
| N-Queens | backtracking | ... | ... | Constraint satisfaction |
| Binary Search | []int | ... | ... | Search on sorted |
